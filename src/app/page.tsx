  ...
  return (
    ...
    <SideBar />
      <div className='flex items-left flex-col gap-7'>
        <p className='text-slate-300 text-2xl font-semibold'>hi, I&apos;m Anabe {'👋'}</p>
        ...
        <div className='flex gap-5'>
          <Link target='_blank' href='https://github.com/anabexd'>
            <Image className='hover:scale-95' src='/mdi_github.svg' width={40} height={40} alt=''></Image>
            </Link>
          <Link target='_blank' href='https://linkedin.com/in/anabe-sc'>
          <Image className='hover:scale-95' src='/mdi_linkedin.svg' width={40} height={40} alt=''></Image>
          </Link>
          <Link target='_blank' href='https://drive.google.com/file/d/18tVLLld8qB_2HfDr6YQDsj2zGgExbaxE/view?usp=sharing'>
          <Image className='hover:scale-95' src='/mdi_paper.svg' width={40} height={40} alt=''></Image>
          </Link>
        </div>
      </div>
    </main>
